...
from .models import (
    ...
    CaseRecord,
    ControlPlaneRecord,
    DetectorLifecycleRecord, EvidenceRecord, FalsePositiveReviewRecord,
    FindingAlertIngestResult,
    HuntRecord, HuntRunRecord, KnownLimitationOwnershipRecord, LeadRecord, LifecycleTransitionRecord,
    NativeDetectionRecord,
    ObservationRecord, ReconciliationRecord, RecommendationRecord,
    SourceHealthRecord, SuppressionProposalRecord,
)
...
RECORD_TYPES_BY_FAMILY: dict[str, Type[ControlPlaneRecord]] = {
    ...
    for record_type in (
        ...
        SuppressionProposalRecord, SourceHealthRecord, KnownLimitationOwnershipRecord, LifecycleTransitionRecord,
        ObservationRecord, LeadRecord, RecommendationRecord, ApprovalDecisionRecord,
