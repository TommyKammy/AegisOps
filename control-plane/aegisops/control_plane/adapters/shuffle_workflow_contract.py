...
def validate_reviewed_workflow(
    ...
    expected_copy["id"] = str(UUID(workflow_id))
    normalize_server_fields(expected_copy, observed_copy)
    require_reviewed_definition(expected_copy, observed_copy, "$")
