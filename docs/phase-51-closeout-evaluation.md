...
| #1044 | Phase 51.3 Pilot, Beta, RC, and GA gate contract | Closed. `docs/phase-51-3-pilot-beta-rc-ga-gate-contract.md` defines evidence gates and keeps Phase 66 as RC; ADR 0020 later clarified that Phase 67 performs bounded GA-prerequisite validation while GA acceptance remains separate. |
