...
- Validation scope: Phase 15 review of the approved analyst-assistant boundary, first-class grounding inputs, identity ambiguity handling, advisory-only ceiling, and CI wiring for the reviewed assistant boundary
...
`docs/phase-15-identity-grounded-analyst-assistant-boundary.md` must continue to define the first-class grounding inputs, identity-ambiguity rules, and advisory-only ceiling.
