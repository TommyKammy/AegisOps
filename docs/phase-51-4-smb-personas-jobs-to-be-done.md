...
| --- | --- | --- |
| Internal IT Manager | Phase 52, Phase 55, Phase 62, Phase 66, Phase 67 | Shapes setup language, daily summaries, leadership-ready reports, RC evidence, Phase 67 bounded GA-prerequisite evidence, and separately accepted GA launch evidence around narrow SMB ownership. |
...
| Bounded External Support Collaborator | Phase 63, Phase 64, Phase 66, Phase 67 | Shapes redacted support-bundle evidence, limitation ownership, supportability proof, Phase 67 bounded GA-prerequisite evidence, and separately accepted GA support-readiness boundaries. |
...
Phase 67 contributes bounded, non-production GA-prerequisite evidence only. GA launch and support-readiness evidence is accepted separately through the GA gate and requires current-revision real-user or design-partner evidence, production-operability evidence, and independent human approval.
