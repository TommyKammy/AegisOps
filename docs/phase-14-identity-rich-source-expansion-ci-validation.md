...
`control-plane/tests/test_service_persistence_ingest_case_lifecycle.py` must continue to guard reviewed-context propagation into alerts, cases, and analyst queues for identity-rich alerts.
