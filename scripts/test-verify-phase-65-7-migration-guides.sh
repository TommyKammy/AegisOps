...
inline_heading_repo="${workdir}/inline-heading"
create_valid_repo "${inline_heading_repo}"
perl -0pi -e 's/^## 4\. Evidence Mapping\n/This paragraph mentions ## 4. Evidence Mapping without preserving the actual heading.\\n/m' "${inline_heading_repo}/docs/migration/phase-65-7-standalone-wazuh-migration-guide.md"
assert_fails_with "${inline_heading_repo}" "Missing Phase 65.7 standalone Wazuh migration guide required section: ## 4. Evidence Mapping"
...
release_candidate_overclaim_repo="${workdir}/release-candidate-overclaim"
create_valid_repo "${release_candidate_overclaim_repo}"
printf '%s\n' "Phase 65.7 proves release-candidate readiness." >>"${release_candidate_overclaim_repo}/docs/migration/phase-65-7-standalone-wazuh-migration-guide.md"
assert_fails_with "${release_candidate_overclaim_repo}" "Forbidden Phase 65.7 migration guide claim matched:"
...
spaced_customer_private_repo="${workdir}/spaced-customer-private"
create_valid_repo "${spaced_customer_private_repo}"
printf '%s\n' "The migration guide includes customer private ticket data." >>"${spaced_customer_private_repo}/docs/migration/phase-65-7-manual-soc-ticket-workflow-migration-guide.md"
assert_fails_with "${spaced_customer_private_repo}" "Forbidden Phase 65.7 migration guide customer-private data"
