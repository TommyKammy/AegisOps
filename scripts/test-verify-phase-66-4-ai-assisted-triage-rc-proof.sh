...
uncited_recommendation_repo="${workdir}/uncited-recommendation"
copy_valid_repo "${uncited_recommendation_repo}"
printf '%s\n' "recommendation_draft_id: uncited" >>"${uncited_recommendation_repo}/docs/phase-66-4-ai-assisted-triage-rc-proof.md"
assert_fails_with "${uncited_recommendation_repo}" "invalid citation evidence detected"

no_citations_recommendation_repo="${workdir}/no-citations-recommendation"
copy_valid_repo "${no_citations_recommendation_repo}"
printf '%s\n' "recommendation_draft_id: no citations" >>"${no_citations_recommendation_repo}/docs/phase-66-4-ai-assisted-triage-rc-proof.md"
assert_fails_with "${no_citations_recommendation_repo}" "invalid citation evidence detected"

no_citations_recommendation_table_repo="${workdir}/no-citations-recommendation-table"
copy_valid_repo "${no_citations_recommendation_table_repo}"
printf '%s\n' "| recommendation_draft_id | no citations | reviewed |" >>"${no_citations_recommendation_table_repo}/docs/phase-66-4-ai-assisted-triage-rc-proof.md"
assert_fails_with "${no_citations_recommendation_table_repo}" "invalid citation evidence detected"
...
unavailable_degraded_posture_repo="${workdir}/unavailable-degraded-posture"
copy_valid_repo "${unavailable_degraded_posture_repo}"
printf '%s\n' "degraded_disabled_posture: unavailable" >>"${unavailable_degraded_posture_repo}/docs/phase-66-4-ai-assisted-triage-rc-proof.md"
assert_passes "${unavailable_degraded_posture_repo}"

unavailable_ai_trace_repo="${workdir}/unavailable-ai-trace"
copy_valid_repo "${unavailable_ai_trace_repo}"
printf '%s\n' "ai_trace_id: unavailable" >>"${unavailable_ai_trace_repo}/docs/phase-66-4-ai-assisted-triage-rc-proof.md"
assert_fails_with "${unavailable_ai_trace_repo}" "missing required evidence value detected"
...
ai_outputs_approve_records_repo="${workdir}/ai-outputs-approve-records"
copy_valid_repo "${ai_outputs_approve_records_repo}"
printf '%s\n' "AI outputs approve AegisOps records." >>"${ai_outputs_approve_records_repo}/docs/phase-66-4-ai-assisted-triage-rc-proof.md"
assert_fails_with "${ai_outputs_approve_records_repo}" "Forbidden Phase 66.4 AI-assisted triage RC proof claim matched"
...
adverbial_ai_authority_repo="${workdir}/adverbial-ai-authority"
copy_valid_repo "${adverbial_ai_authority_repo}"
printf '%s\n' "AI output directly approves AegisOps records." >>"${adverbial_ai_authority_repo}/docs/phase-66-4-ai-assisted-triage-rc-proof.md"
assert_fails_with "${adverbial_ai_authority_repo}" "Forbidden Phase 66.4 AI-assisted triage RC proof claim matched"
...
recommendation_text_authority_repo="${workdir}/recommendation-text-authority"
copy_valid_repo "${recommendation_text_authority_repo}"
printf '%s\n' "Recommendation text approves AegisOps records." >>"${recommendation_text_authority_repo}/docs/phase-66-4-ai-assisted-triage-rc-proof.md"
assert_fails_with "${recommendation_text_authority_repo}" "Forbidden Phase 66.4 AI-assisted triage RC proof claim matched"

recommendation_draft_authority_repo="${workdir}/recommendation-draft-authority"
copy_valid_repo "${recommendation_draft_authority_repo}"
printf '%s\n' "Recommendation draft approves AegisOps records." >>"${recommendation_draft_authority_repo}/docs/phase-66-4-ai-assisted-triage-rc-proof.md"
assert_fails_with "${recommendation_draft_authority_repo}" "Forbidden Phase 66.4 AI-assisted triage RC proof claim matched"

cited_summary_authority_repo="${workdir}/cited-summary-authority"
copy_valid_repo "${cited_summary_authority_repo}"
printf '%s\n' "Cited summary closes cases." >>"${cited_summary_authority_repo}/docs/phase-66-4-ai-assisted-triage-rc-proof.md"
assert_fails_with "${cited_summary_authority_repo}" "Forbidden Phase 66.4 AI-assisted triage RC proof claim matched"
...
modal_prompt_injection_overrides_repo="${workdir}/modal-prompt-injection-overrides"
copy_valid_repo "${modal_prompt_injection_overrides_repo}"
printf '%s\n' "Prompt injection compliance can override AegisOps policy." >>"${modal_prompt_injection_overrides_repo}/docs/phase-66-4-ai-assisted-triage-rc-proof.md"
assert_fails_with "${modal_prompt_injection_overrides_repo}" "Forbidden Phase 66.4 AI-assisted triage RC proof claim matched"
...
phase_proves_release_candidate_readiness_repo="${workdir}/phase-proves-release-candidate-readiness"
copy_valid_repo "${phase_proves_release_candidate_readiness_repo}"
printf '%s\n' "Phase 66.4 proves release-candidate readiness." >>"${phase_proves_release_candidate_readiness_repo}/docs/phase-66-4-ai-assisted-triage-rc-proof.md"
assert_fails_with "${phase_proves_release_candidate_readiness_repo}" "Forbidden Phase 66.4 AI-assisted triage RC proof claim matched"
...
verifier_output_readiness_truth_repo="${workdir}/verifier-output-readiness-truth"
copy_valid_repo "${verifier_output_readiness_truth_repo}"
printf '%s\n' "Verifier output proves readiness truth." >>"${verifier_output_readiness_truth_repo}/docs/phase-66-4-ai-assisted-triage-rc-proof.md"
assert_fails_with "${verifier_output_readiness_truth_repo}" "Forbidden Phase 66.4 AI-assisted triage RC proof claim matched"

model_output_ga_readiness_repo="${workdir}/model-output-ga-readiness"
copy_valid_repo "${model_output_ga_readiness_repo}"
printf '%s\n' "Model output proves GA readiness." >>"${model_output_ga_readiness_repo}/docs/phase-66-4-ai-assisted-triage-rc-proof.md"
assert_fails_with "${model_output_ga_readiness_repo}" "Forbidden Phase 66.4 AI-assisted triage RC proof claim matched"

assistant_output_rc_readiness_repo="${workdir}/assistant-output-rc-readiness"
copy_valid_repo "${assistant_output_rc_readiness_repo}"
printf '%s\n' "Assistant output proves RC readiness." >>"${assistant_output_rc_readiness_repo}/docs/phase-66-4-ai-assisted-triage-rc-proof.md"
assert_fails_with "${assistant_output_rc_readiness_repo}" "Forbidden Phase 66.4 AI-assisted triage RC proof claim matched"

issue_lint_output_readiness_truth_repo="${workdir}/issue-lint-output-readiness-truth"
copy_valid_repo "${issue_lint_output_readiness_truth_repo}"
printf '%s\n' "issue-lint output proves readiness truth." >>"${issue_lint_output_readiness_truth_repo}/docs/phase-66-4-ai-assisted-triage-rc-proof.md"
assert_fails_with "${issue_lint_output_readiness_truth_repo}" "Forbidden Phase 66.4 AI-assisted triage RC proof claim matched"

ai_source_truth_for_approvals_repo="${workdir}/ai-source-truth-for-approvals"
copy_valid_repo "${ai_source_truth_for_approvals_repo}"
printf '%s\n' "AI output is the source of truth for approvals." >>"${ai_source_truth_for_approvals_repo}/docs/phase-66-4-ai-assisted-triage-rc-proof.md"
assert_fails_with "${ai_source_truth_for_approvals_repo}" "Forbidden Phase 66.4 AI-assisted triage RC proof claim matched"
...
printf '%s\n' "<!-- api_key: abcdefghijklmnop -->" >>"${comment_secret_repo}/docs/phase-66-4-ai-assisted-triage-rc-proof.md"
...
printf '%s\n' "<!-- customer-private ticket export -->" >>"${comment_customer_private_repo}/docs/phase-66-4-ai-assisted-triage-rc-proof.md"
...
wrapped_readme_authority_repo="${workdir}/wrapped-readme-authority"
copy_valid_repo "${wrapped_readme_authority_repo}"
printf '%s\n%s\n' "Phase 66.4 AI output" "approves AegisOps records." >>"${wrapped_readme_authority_repo}/README.md"
assert_fails_with "${wrapped_readme_authority_repo}" "Forbidden Phase 66.4 README claim matched"
