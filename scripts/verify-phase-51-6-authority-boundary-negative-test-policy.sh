...
forbidden_lines=(
  ...
  "Wazuh alert status may release AegisOps records"
  "Wazuh alert status may gate AegisOps records"
  "Wazuh may release AegisOps records"
  "Wazuh may gate AegisOps records"
  "Wazuh may release"
  "Wazuh may gate"
  "Shuffle workflow success may close AegisOps records"
  "Shuffle workflow success may reconcile AegisOps records"
  "Shuffle workflow success may release AegisOps records"
  "Shuffle workflow success may gate AegisOps records"
  "Shuffle may release AegisOps records"
  "Shuffle may gate AegisOps records"
  "Shuffle may release"
  "Shuffle may gate"
  "Ticket status may close AegisOps records"
  "Ticket status may approve AegisOps records"
  "Ticket status may reconcile AegisOps records"
  "Ticket status may release AegisOps records"
  "Ticket status may gate AegisOps records"
  "Ticket may approve AegisOps records"
  "Ticket may reconcile AegisOps records"
  "Ticket may release AegisOps records"
  "Ticket may gate AegisOps records"
  "Ticket may approve"
  "Ticket may reconcile"
  "Ticket may release"
  "Ticket may gate"
  "Browser state is workflow truth"
  "UI cache is workflow truth"
  "Downstream receipts are reconciliation truth"
  "Downstream receipts are closeout truth"
  "Downstream may closeout AegisOps records"
  "Downstream may closeout"
  "Downstream may close out"
  "Downstream closeout is workflow truth"
  "Closeout is workflow truth"
