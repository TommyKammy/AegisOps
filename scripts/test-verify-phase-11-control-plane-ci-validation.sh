...
remove_text_from_file "${missing_test_repo}" "control-plane/tests/test_service_persistence_action_reconciliation.py" "def test_service_reconcile_action_execution_supports_generic_execution_surfaces("
commit_fixture "${missing_test_repo}"
assert_fails_with "${missing_test_repo}" "Missing required Phase 11 test in ${missing_test_repo}/control-plane/tests/test_service_persistence_action_reconciliation.py: test_service_reconcile_action_execution_supports_generic_execution_surfaces"
