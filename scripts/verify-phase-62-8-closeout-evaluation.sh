...
if claim_scan_text "${absolute_doc_path}" | awk -v allowed_non_claim_line="${allowed_non_claim_line_lower}" \
  -v required_rejection_line="${required_rejection_line_lower}" '
  {
    ...
    if (line ~ /(^|[^[:alnum:]_])phase[- ]62([^.]*[[:space:]])?(is|are|was|were|be|been|becomes|became|has been|have been|had been)[[:space:]]+not([[:space:]]+yet)?([^.]*[[:space:]])?(beta|rc|ga|release candidate|general availability|generally available|release|production|commercial|commercially|commercial readiness|commercial replacement|self-service commercial)([^.]*[[:space:]])?(ready|readiness|complete|accepted|verified|proven)?([^[:alnum:]_]|$)/ ||
        line ~ /(^|[^[:alnum:]_])phase[- ]62([^.]*[[:space:]])?(is|are|was|were|be|been|becomes|became|has been|have been|had been)[[:space:]]+not([[:space:]]+yet)?[[:space:]]+ready[[:space:]]+for[[:space:]]+commercial[[:space:]]+replacement([^[:alnum:]_]|$)/ ||
        line ~ /(^|[^[:alnum:]_])aegisops[[:space:]]+(is|are|was|were|be|been|becomes|became|has been|have been|had been)[[:space:]]+not([[:space:]]+yet)?([^.]*[[:space:]])?(beta|rc|ga|release[- ]candidate|general availability|generally available|self-service commercial readiness|self-service commercially[- ]ready|commercial readiness|commercially[- ]ready|production[- ]ready)([^[:alnum:]_]|$)/ ||
        line ~ /(^|[^[:alnum:]_])phase[- ]6[36][[:space:]]+(evidence[- ]expansion|rc[- ]proof)([^.]*[[:space:]])?(is|are|was|were|be|been|becomes|became|has been|have been|had been)[[:space:]]+not([[:space:]]+yet)?([^.]*[[:space:]])?(complete|completed|completion|ready|verified|accepted|done|implemented|available|supported|shipped|released|delivered)([^[:alnum:]_]|$)/) {
      next
    }
    positive_assertion = line ~ /(^|[^[:alnum:]_])phase[- ]62([^.]*[[:space:]])?(is|are|becomes|became|reached|reaches|achieved|achieves|proves|ships|includes|validates|establishes|satisfies|confirms|certifies|has|have|had)([^.]*[[:space:]])?(beta|rc|ga|release candidate|general availability|generally available|release|production)/ ||
      ...
      line ~ /(^|[^[:alnum:]_])phase[- ]6[36][[:space:]]+(evidence[- ]expansion|rc[- ]proof)([^.]*[[:space:]])?(is[[:space:]]+)?(fully[[:space:]]+)?(complete|completed|completion|ready|verified|accepted|done|implemented|available|supported|shipped|released|delivered)/ ||
      ...
      line ~ /(^|[^[:alnum:]_])phase[- ]6[36]([^.]*[[:space:]])?(has|have|had|got)([^.]*[[:space:]])?(completed|delivered|shipped|released|implemented|finished)([^.]*[[:space:]])?(evidence[- ]expansion|rc[- ]proof)/ ||
      ...
      line ~ /(^|[^[:alnum:]_])(downstream workflow|shuffle workflow|workflow|simulator output|ticket state|ticket status|downstream ticket|ui cache|ui state|ui surface|browser state|browser cache|ai output|source-native state|source native state|verifier output|issue-lint output|issue lint output)([[:space:]]+(state|status|output|cache|surface))?[[:space:]]+(is|are|becomes|became|counts as|served as|serves as|acted as|acts as|represented|represents|approved|approves|authorized|authorizes|executed|executes|reconciled|reconciles|closed|closes|gated|gates|validated|validates|claimed|claims|can|could|may|might|will|would|should)/
    ...
    if (line ~ /(^|[^[:alnum:]_])aegisops[[:space:]]+is[[:space:]]+((a[[:space:]]+)?commercial[[:space:]]+replacement([[:space:]]+ready)?|beta|rc|ga|release[- ]candidate([[:space:]-]+ready)?|generally available|self-service commercially[- ]ready|commercially[- ]ready|production[- ]ready)([^[:alnum:]_]|$)/) {
      found_kind = "release-readiness overclaim"
    }
    if (line ~ /(^|[^[:alnum:]_])aegisops[[:space:]]+(is|was|were|becomes|became|remains|remained|reached|reaches|achieved|achieves|entered|enters|shipped|ships|went|goes)([[:space:]]+[[:alpha:]-]+){0,3}[[:space:]]+((a[[:space:]]+)?commercial[[:space:]]+replacement([[:space:]]+ready)?|beta|rc|ga|release[- ]candidate([[:space:]-]+ready)?|general availability|generally available|self-service commercial readiness|self-service commercially[- ]ready|commercial readiness|commercially[- ]ready|production[- ]ready)([^[:alnum:]_]|$)/) {
      found_kind = "release-readiness overclaim"
    }
    if (line ~ /(^|[^[:alnum:]_])aegisops[[:space:]]+is[[:space:]]+generally[[:space:]]+available[[:space:]]*(\(|$)/) {
      found_kind = "release-readiness overclaim"
    }
    if (line ~ /(^|[^[:alnum:]_])aegisops[[:space:]]+(becomes|became|reached|reaches|achieved|achieves|entered|enters|shipped|ships|went|goes)[[:space:]]+(beta|rc|ga|release[- ]candidate([[:space:]-]+ready)?|general availability|generally available|self-service commercial readiness|self-service commercially[- ]ready|commercial readiness|commercially[- ]ready|production[- ]ready)([^[:alnum:]_]|$)/) {
      found_kind = "release-readiness overclaim"
    }
    if (line ~ /(^|[^[:alnum:]_])aegisops[[:space:]]+(has|have|had)[[:space:]]+(become|gone|reached|achieved|entered|shipped|proven|proved|confirmed|certified|validated)[[:space:]]+(beta|rc|ga|release[- ]candidate([[:space:]-]+ready)?|general availability|generally available|self-service commercial readiness|self-service commercially[- ]ready|commercial readiness|commercially[- ]ready|production[- ]ready)([[:space:]-]+(readiness|ready))?([^[:alnum:]_]|$)/) {
      found_kind = "release-readiness overclaim"
    }
    ...
    if (line ~ /(^|[^[:alnum:]_])phase[- ]6[36][[:space:]]+(evidence[- ]expansion|rc[- ]proof)([^.]*[[:space:]])?(is[[:space:]]+)?(fully[[:space:]]+)?(complete|completed|completion|ready|verified|accepted|done|implemented|available|supported|shipped|released|delivered)([^[:alnum:]_]|$)/) {
      found_kind = "release-readiness overclaim"
    }
    ...
    if (line ~ /(^|[^[:alnum:]_])phase[- ]6[36]([^.]*[[:space:]])?(has|have|had|got)([^.]*[[:space:]])?(completed|delivered|shipped|released|implemented|finished)([^.]*[[:space:]])?(evidence[- ]expansion|rc[- ]proof)([^[:alnum:]_]|$)/) {
      found_kind = "release-readiness overclaim"
    }
    ...
    if (line ~ /(^|[^[:alnum:]_])(controlled[- ]write|hard[- ]write)([^.]*[[:space:]])?(has|have|had)[[:space:]]+been([^.]*[[:space:]])?(enabled|available|active|supported|complete|implemented|ready|delivered|shipped)([^.]*[[:space:]])?(by[[:space:]]+default|as[[:space:]]+default|default)([^[:alnum:]_]|$)/) {
      found_kind = "write-default overclaim"
    }
    ...
    if (line ~ /(^|[^[:alnum:]_])phase[- ]62([^.]*[[:space:]])?(is|are|was|were|becomes|became|remains|remained|has been|have been|had been)([^.]*[[:space:]])?ready[[:space:]]+for[[:space:]]+commercial[[:space:]]+replacement([^[:alnum:]_]|$)/) {
      found_kind = "release-readiness overclaim"
    }
    ...
    if (line ~ /(^|[^[:alnum:]_])phase[- ]62([^.]*[[:space:]])?(accepts|allows|trusts|validates|proves|ships|includes|uses)([^.]*[[:space:]])?(production|prod|live)[- ]secret(s)?([^[:alnum:]_]|$)/) {
      found_kind = "production-secret overclaim"
    }
    if (line ~ /(^|[^[:alnum:]_])(downstream workflow|shuffle workflow|workflow|simulator output|ticket state|ticket status|downstream ticket|ui cache|ui state|ui surface|browser state|browser cache|ai output|source-native state|source native state|verifier output|issue-lint output|issue lint output)([[:space:]]+(state|status|output|cache|surface))?([^.]*[[:space:]])?(is|are|becomes|became|counts as|serves as|acts as|represents)?([^.]*[[:space:]])?(aegisops|production|authoritative|approval|execution|reconciliation|case|workflow)?[[:space:]]*(truth|authority|authoritative|source[- ]of[- ]truth)([^[:alnum:]_]|$)/) {
      found_kind = "subordinate-surface authority overclaim"
    }
    if (line ~ /(^|[^[:alnum:]_])(ui cache|ui state|ui surface|browser state|browser cache|ticket state|ticket status|downstream ticket|simulator output|downstream workflow|shuffle workflow|ai output|source-native state|source native state|verifier output|issue-lint output|issue lint output)([[:space:]]+(state|status|output|cache|surface))?[[:space:]]+(approved|approves|authorized|authorizes|executed|executes|reconciled|reconciles|closed|closes|gated|gates|validated|validates|claimed|claims)([^[:alnum:]_]|$|[[:space:]])/) {
      found_kind = "subordinate-surface authority overclaim"
    }
    if (line ~ /(^|[^[:alnum:]_])(ui cache|ui state|ui surface|browser state|browser cache|ticket state|ticket status|downstream ticket|simulator output|downstream workflow|shuffle workflow|ai output|source-native state|source native state|verifier output|issue-lint output|issue lint output)([[:space:]]+(state|status|output|cache|surface))?[[:space:]]+(can|could|may|might|will|would|should)([[:space:]]+[[:alpha:]-]+){0,3}[[:space:]]+(approve|authorize|execute|reconcile|close|gate|validate|claim)(s|d)?([^[:alnum:]_]|$|[[:space:]])/) {
      found_kind = "subordinate-surface authority overclaim"
    }
    if (line ~ /(^|[^[:alnum:]_])(ui cache|ui state|ui surface|browser state|browser cache|ticket state|ticket status|downstream ticket|simulator output|downstream workflow|shuffle workflow|ai output|source-native state|source native state|verifier output|issue-lint output|issue lint output)([[:space:]]+(state|status|output|cache|surface))?[[:space:]]+(has|have|had)([[:space:]]+[[:alpha:]-]+){0,3}[[:space:]]+(approved|authorized|executed|reconciled|closed|gated|validated|claimed)([^[:alnum:]_]|$|[[:space:]])/) {
      found_kind = "subordinate-surface authority overclaim"
    }
  }
  END {
