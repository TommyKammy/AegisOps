...
inline_non_claims_repo="${workdir}/inline-non-claims"
create_valid_repo "${inline_non_claims_repo}"
printf '%s\n' "non_claims: {silent_auto_upgrade: true}" >>"${inline_non_claims_repo}/docs/deployment/release/phase-65-3-upgrade-manifest.yaml"
assert_fails_with "${inline_non_claims_repo}" "Invalid Phase 65.3 upgrade manifest value: non_claims"
...
embedded_placeholder_source_repo="${workdir}/embedded-placeholder-source-version"
create_valid_repo "${embedded_placeholder_source_repo}"
perl -0pi -e 's/^    source_version: aegisops-0\.4\.0-reviewed$/    source_version: aegisops-tbd-reviewed/m; s/^    compatibility_reason: Source version aegisops-0\.4\.0-reviewed/    compatibility_reason: Source version aegisops-tbd-reviewed/m' "${embedded_placeholder_source_repo}/docs/deployment/release/phase-65-3-upgrade-manifest.yaml"
assert_fails_with "${embedded_placeholder_source_repo}" "Invalid Phase 65.3 upgrade manifest compatibility case field: compatible-reviewed-source.source_version"
...
perl -0pi -e 's/^    rollback_expectation: rollback_owner=aegisops-release-owner; rollback_trigger=failed required checks or release-gate rejection; rollback_target=last-reviewed-release-bundle$/    rollback_expectation: automatic rollback/m' "${automatic_rollback_repo}/docs/deployment/release/phase-65-3-upgrade-manifest.yaml"
...
perl -0pi -e 's/^    rollback_evidence_reference: docs\/phase-58-5-upgrade-rollback-plan-contract.md\n//mg' "${missing_rollback_evidence_repo}/docs/deployment/release/phase-65-3-upgrade-manifest.yaml"
assert_fails_with "${missing_rollback_evidence_repo}" "Missing Phase 65.3 upgrade manifest compatibility case field: compatible-reviewed-source.rollback_evidence_reference"

embedded_rollback_evidence_repo="${workdir}/embedded-rollback-evidence"
create_valid_repo "${embedded_rollback_evidence_repo}"
perl -0pi -e 's/^    rollback_expectation: (.*)$/    rollback_expectation: $1; rollback_evidence_reference=docs\/phase-58-5-upgrade-rollback-plan-contract.md/m' "${embedded_rollback_evidence_repo}/docs/deployment/release/phase-65-3-upgrade-manifest.yaml"
assert_fails_with "${embedded_rollback_evidence_repo}" "Invalid Phase 65.3 upgrade manifest compatibility case field: compatible-reviewed-source.rollback_expectation"

rollback_only_evidence_repo="${workdir}/rollback-only-evidence"
create_valid_repo "${rollback_only_evidence_repo}"
perl -0pi -e 's/^    rollback_expectation: .*$/    rollback_expectation: rollback_owner=aegisops-release-owner/mg' "${rollback_only_evidence_repo}/docs/deployment/release/phase-65-3-upgrade-manifest.yaml"
...
duplicate_case_identifier_repo="${workdir}/duplicate-case-identifier"
create_valid_repo "${duplicate_case_identifier_repo}"
perl -0pi -e 's/^  - case_identifier: incompatible-unreviewed-source$/  - case_identifier: compatible-reviewed-source/m' "${duplicate_case_identifier_repo}/docs/deployment/release/phase-65-3-upgrade-manifest.yaml"
assert_fails_with "${duplicate_case_identifier_repo}" "Invalid Phase 65.3 upgrade manifest compatibility case field: compatible-reviewed-source.case_identifier"
...
hyphenated_per_case_release_channel_repo="${workdir}/hyphenated-per-case-release-channel"
create_valid_repo "${hyphenated_per_case_release_channel_repo}"
perl -0pi -e 's/^  - case_identifier: compatible-reviewed-source$/  - case_identifier: compatible-reviewed-source\n    release-channel: ga/m' "${hyphenated_per_case_release_channel_repo}/docs/deployment/release/phase-65-3-upgrade-manifest.yaml"
assert_fails_with "${hyphenated_per_case_release_channel_repo}" "Invalid Phase 65.3 upgrade manifest compatibility case field: compatible-reviewed-source.release-channel"
...
auto_migration_enabled_repo="${workdir}/auto-migration-enabled"
create_valid_repo "${auto_migration_enabled_repo}"
printf '%s\n' "Auto migration is enabled." >>"${auto_migration_enabled_repo}/docs/release/phase-65-beta-release-notes.md"
assert_fails_with "${auto_migration_enabled_repo}" "silent auto-upgrade or automatic migration claim"
...
auto_rollback_enabled_repo="${workdir}/auto-rollback-enabled"
create_valid_repo "${auto_rollback_enabled_repo}"
printf '%s\n' "Auto rollback is enabled." >>"${auto_rollback_enabled_repo}/docs/release/phase-65-beta-release-notes.md"
assert_fails_with "${auto_rollback_enabled_repo}" "silent auto-upgrade or automatic migration claim"
...
hosted_update_predicate_repo="${workdir}/hosted-update-predicate"
create_valid_repo "${hosted_update_predicate_repo}"
printf '%s\n' "Update service is hosted for beta users." >>"${hosted_update_predicate_repo}/docs/release/phase-65-beta-release-notes.md"
assert_fails_with "${hosted_update_predicate_repo}" "hosted update-service claim"
...
phase67_is_ga_repo="${workdir}/phase-67-is-ga"
create_valid_repo "${phase67_is_ga_repo}"
printf '%s\n' "| Phase 67 is GA |" >>"${phase67_is_ga_repo}/docs/release/phase-65-beta-release-notes.md"
assert_fails_with "${phase67_is_ga_repo}" "inferred RC/GA readiness claim"

phase67_becomes_ga_repo="${workdir}/phase-67-becomes-ga"
create_valid_repo "${phase67_becomes_ga_repo}"
printf '%s\n' "Phase 67 becomes GA." >>"${phase67_becomes_ga_repo}/docs/release/phase-65-beta-release-notes.md"
assert_fails_with "${phase67_becomes_ga_repo}" "inferred RC/GA readiness claim"
...
phase67_stays_ga_repo="${workdir}/phase-67-stays-ga"
create_valid_repo "${phase67_stays_ga_repo}"
printf '%s\n' "Phase 67 stays the GA gate." >>"${phase67_stays_ga_repo}/docs/release/phase-65-beta-release-notes.md"
assert_fails_with "${phase67_stays_ga_repo}" "inferred RC/GA readiness claim"

phase67_equals_ga_repo="${workdir}/phase-67-equals-ga"
create_valid_repo "${phase67_equals_ga_repo}"
printf '%s\n' "Phase 67 equals GA" >>"${phase67_equals_ga_repo}/docs/release/phase-65-beta-release-notes.md"
assert_fails_with "${phase67_equals_ga_repo}" "inferred RC/GA readiness claim"

phase67_accepts_ga_repo="${workdir}/phase-67-accepts-ga"
create_valid_repo "${phase67_accepts_ga_repo}"
printf '%s\n' "Phase 67 accepts GA." >>"${phase67_accepts_ga_repo}/docs/release/phase-65-beta-release-notes.md"
assert_fails_with "${phase67_accepts_ga_repo}" "inferred RC/GA readiness claim"

phase67_materializes_ga_repo="${workdir}/phase-67-materializes-ga"
create_valid_repo "${phase67_materializes_ga_repo}"
printf '%s\n' "Phase 67 materializes the GA gate." >>"${phase67_materializes_ga_repo}/docs/release/phase-65-beta-release-notes.md"
assert_fails_with "${phase67_materializes_ga_repo}" "inferred RC/GA readiness claim"

phase67_completion_accepts_ga_repo="${workdir}/phase-67-completion-accepts-ga"
create_valid_repo "${phase67_completion_accepts_ga_repo}"
printf '%s\n' "Completing Phase 67 accepts the GA gate." >>"${phase67_completion_accepts_ga_repo}/docs/release/phase-65-beta-release-notes.md"
assert_fails_with "${phase67_completion_accepts_ga_repo}" "inferred RC/GA readiness claim"

phase67_split_table_repo="${workdir}/phase-67-split-table"
create_valid_repo "${phase67_split_table_repo}"
printf '%s\n' "| Phase 67 | becomes | the GA gate |" >>"${phase67_split_table_repo}/docs/release/phase-65-beta-release-notes.md"
assert_fails_with "${phase67_split_table_repo}" "inferred RC/GA readiness claim"

phase67_colon_mapping_repo="${workdir}/phase-67-colon-mapping"
create_valid_repo "${phase67_colon_mapping_repo}"
printf '%s\n' "Phase 67: becomes the GA gate." >>"${phase67_colon_mapping_repo}/docs/release/phase-65-beta-release-notes.md"
assert_fails_with "${phase67_colon_mapping_repo}" "inferred RC/GA readiness claim"

phase67_unrelated_negation_repo="${workdir}/phase-67-unrelated-negation"
create_valid_repo "${phase67_unrelated_negation_repo}"
printf '%s\n' "This release is not a drill: Phase 67 is GA." >>"${phase67_unrelated_negation_repo}/docs/release/phase-65-beta-release-notes.md"
assert_fails_with "${phase67_unrelated_negation_repo}" "inferred RC/GA readiness claim"

phase67_negation_before_positive_repo="${workdir}/phase-67-negation-before-positive"
create_valid_repo "${phase67_negation_before_positive_repo}"
printf '%s\n' "This does not claim production readiness, but Phase 67 remains GA." >>"${phase67_negation_before_positive_repo}/docs/release/phase-65-beta-release-notes.md"
assert_fails_with "${phase67_negation_before_positive_repo}" "inferred RC/GA readiness claim"

phase67_ga_non_claims_repo="${workdir}/phase-67-ga-non-claims"
create_valid_repo "${phase67_ga_non_claims_repo}"
printf '%s\n' \
  "Phase 67 is not GA." \
  "This does not claim Phase 67 remains GA." \
  "Phase 67 cannot become GA." \
  "Phase 67 does not accept GA." \
  "Phase 67 cannot materialize GA." \
  "Phase 67 is GA-prerequisite validation." \
  "Phase 67 remains GA prerequisites." \
  '"Phase 67 stays the GA gate" is forbidden.' \
  "Forbidden wording: Phase 67 accepts GA." \
  "These are not claims: Phase 67 remains GA." \
  >>"${phase67_ga_non_claims_repo}/docs/release/phase-65-beta-release-notes.md"
assert_passes "${phase67_ga_non_claims_repo}"
...
rc_gate_approved_repo="${workdir}/rc-gate-approved"
create_valid_repo "${rc_gate_approved_repo}"
printf '%s\n' "RC gate is approved." >>"${rc_gate_approved_repo}/docs/release/phase-65-beta-release-notes.md"
assert_fails_with "${rc_gate_approved_repo}" "inferred RC/GA readiness claim"

issue_lint_readiness_repo="${workdir}/issue-lint-readiness"
create_valid_repo "${issue_lint_readiness_repo}"
printf '%s\n' "Issue-lint proves readiness." >>"${issue_lint_readiness_repo}/docs/release/phase-65-beta-release-notes.md"
assert_fails_with "${issue_lint_readiness_repo}" "inferred RC/GA readiness claim"
...
production_billing_live_repo="${workdir}/production-billing-live"
create_valid_repo "${production_billing_live_repo}"
printf '%s\n' "Production billing is live." >>"${production_billing_live_repo}/docs/release/phase-65-beta-release-notes.md"
assert_fails_with "${production_billing_live_repo}" "entitlement, billing, or commercial readiness claim"
...
workflow_closure_repo="${workdir}/workflow-closure"
create_valid_repo "${workflow_closure_repo}"
printf '%s\n' "The manifest closes workflows and reconciles actions." >>"${workflow_closure_repo}/docs/release/phase-65-beta-release-notes.md"
assert_fails_with "${workflow_closure_repo}" "authority-boundary success claim"
...
production_secret_material_repo="${workdir}/production-secret-material"
create_valid_repo "${production_secret_material_repo}"
printf '%s\n' "production secret material: actual-production-token" >>"${production_secret_material_repo}/docs/release/phase-65-beta-release-notes.md"
assert_fails_with "${production_secret_material_repo}" "production secret-looking value"
...
reversed_customer_private_repo="${workdir}/reversed-customer-private"
create_valid_repo "${reversed_customer_private_repo}"
printf '%s\n' "private customer data: tenant-record-123" >>"${reversed_customer_private_repo}/docs/release/phase-65-beta-release-notes.md"
assert_fails_with "${reversed_customer_private_repo}" "customer-private data detected"
