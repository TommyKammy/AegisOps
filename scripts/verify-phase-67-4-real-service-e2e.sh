...
require_fixed "${e2e_root}/build_evidence.py" '_validate_restart_wazuh_scope'
require_fixed "${e2e_root}/build_evidence.py" '_load_wazuh_observations'
require_fixed "${e2e_root}/build_evidence.py" 'does not use the Wazuh observation time'
