...
citation_shortcut_regex='(^|[[:space:]>*-])`?(source_evidence_references|cited_summary_id)`?[[:space:]]*[:=][^.[:cntrl:]]*(uncited|no[[:space:]_-]*citations?|invented|hidden[[:space:]_-]*source|assistant[[:space:]_-]*prose|model[[:space:]_-]*output)'
citation_shortcut_table_regex='(^|[[:space:]>*-])\|[[:space:]]*`?(source_evidence_references|cited_summary_id)`?[[:space:]]*\|[[:space:]]*`?[^`|]*(uncited|no[[:space:]_-]*citations?|invented|hidden[[:space:]_-]*source|assistant[[:space:]_-]*prose|model[[:space:]_-]*output)[^`|]*`?[[:space:]]*\|'
