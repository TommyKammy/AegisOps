...
mutated_packet_case "upgrade-missing-backup-reference" "upgrade_plan" "backup_reference=aegisops://evidence/backup-007; " "" "invalid upgrade_plan"
mutated_packet_case "upgrade-ticket-backup-reference" "upgrade_plan" "backup_reference=aegisops://evidence/backup-007" "backup_reference=ticket://private/77" "invalid upgrade_plan"
mutated_packet_case "upgrade-mismatched-backup-reference" "upgrade_plan" "backup_reference=aegisops://evidence/backup-007" "backup_reference=aegisops://evidence/backup-008" "backup_reference must match packet backup evidence or restore dry-run evidence"
...
upgrade_restore_reference_repo="${workdir}/upgrade-restore-reference"
copy_valid_repo "${upgrade_restore_reference_repo}"
append_complete_packet "${upgrade_restore_reference_repo}"
replace_doc_text \
  "${upgrade_restore_reference_repo}" \
  "upgrade_plan" \
  "backup_reference=aegisops://evidence/backup-007" \
  "backup_reference=aegisops://evidence/restore-dry-007"
assert_passes "${upgrade_restore_reference_repo}"
...
forbidden_claim_case "support-operator-receives-authority" "Support operator receives authority to approve actions."
forbidden_claim_case "support-team-was-authorized" "Support team was authorized to execute actions."
forbidden_claim_case "support-pronoun-authority" "Support operator has no release authority, but they can approve actions."
forbidden_claim_case "bundle-has-authority" "Support bundle has authority to approve actions."
forbidden_claim_case "bundle-has-the-authority" "Support bundle has the authority to execute actions."
forbidden_claim_case "bundle-is-authorized" "Support bundle is authorized to reconcile AegisOps records."
forbidden_claim_case "bundle-delegated-authority" "Support bundle is delegated authority to close cases."
forbidden_claim_case "bundle-had-authority" "Support bundle had authority to approve actions."
forbidden_claim_case "bundle-was-authorized" "Support bundle was authorized to execute actions."
...
append_doc_line "${safe_non_claim_repo}" "Support operator does not receive authority to approve actions."
append_doc_line "${safe_non_claim_repo}" "Support team was not authorized to execute actions."
append_doc_line "${safe_non_claim_repo}" "Support bundle has no authority to approve actions."
append_doc_line "${safe_non_claim_repo}" "Support bundle is not authorized to execute actions."
...
leak_case "public-key-leak" "-----BEGIN PUBLIC KEY-----" "production secret-looking value detected"
leak_case "rsa-public-key-leak" "-----BEGIN RSA PUBLIC KEY-----" "production secret-looking value detected"
leak_case "pgp-public-key-block-leak" "-----BEGIN PGP PUBLIC KEY BLOCK-----" "production secret-looking value detected"
leak_case "pkcs7-certificate-leak" "-----BEGIN PKCS7-----" "production secret-looking value detected"
leak_case "certificate-chain-leak" "-----BEGIN CERTIFICATE CHAIN-----" "production secret-looking value detected"
leak_case "encrypted-private-key-leak" "-----BEGIN ENCRYPTED PRIVATE KEY-----" "production secret-looking value detected"
leak_case "dsa-private-key-end-leak" "-----END DSA PRIVATE KEY-----" "production secret-looking value detected"
